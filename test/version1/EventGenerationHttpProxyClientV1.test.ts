...
import { EventGenerationHttpProxyClientV1 } from '../../src/version1/EventGenerationHttpProxyClientV1';
...
var CLUSTER: ClusterV1 = {
    ...
    api_host: 'localhost',
    service_ports: { 
        'iqs-services-eventgeneration': 3000 
    },
    active_tenants: ['1']
}

suite('EventGenerationHttpProxyClientV1', ()=> {
    let service: EventGenerationHttpServiceV1;
    let client: EventGenerationHttpProxyClientV1;
    ...
    suiteSetup((done) => {
        ...
        client = new EventGenerationHttpProxyClientV1();
